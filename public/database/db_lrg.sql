...
--
-- Host: localhost
-- Generation Time: Mar 29, 2021 at 05:07 PM
...
CREATE TABLE `tbl_announcements` (
  ...
  `announcement_date` timestamp(6) NOT NULL DEFAULT current_timestamp(6)
...
(1, 'Taylor', 'admin', 'admin', 'test@test.ca', '2021-02-24 14:19:09', '127.0.0.1', 1),
(2, 'test', 'test', 'test', 'test@test.ca', '2021-03-29 13:08:41', 'no', 0);
